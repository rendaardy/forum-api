...
import {ReplyRepositoryPostgres} from '../reply-repository-postgres.js';
...
describe('ReplyRepositoryPostgres', () => {
	...
	describe('removeReply method', () => {
		...
		it('should throw an error when reply isn\'t found', async () => {
			...
			await expect(() => replyRepository.removeReply('reply-xyz'))
	...
	describe('verifyReplyOwner method', () => {
		...
		it('should throw an error when reply isn\'t found', async () => {
			...
			await expect(() => replyRepository.verifyReplyOwner('user-abc234', 'reply-abc'))
		...
		it('should throw an error when reply isn\'t owned by the user', async () => {
			...
			await expect(() => replyRepository.verifyReplyOwner('user-abc', 'reply-abc123'))
		...
		it('should successfully verify when reply is owned by the user', async () => {
			...
			expect(() => replyRepository.verifyReplyOwner('user-abc234', 'reply-abc123'))
