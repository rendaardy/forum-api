...
export class DomainErrorTranslator {
	static #directories = new Map([
		...
		['REGISTER_USER.USERNAME_CONTAIN_FORBIDDEN_CHARACTERS', new InvariantError('tidak dapat membuat user baru karena username mengandung karakter terlarang')],
		...
		['CREATE_REPLY.NOT_MEET_REQUIRED_PROPERTIES', new InvariantError('Failed to create a new reply. Missing the required properties')],
		['CREATE_REPLY.TYPE_MISMATCH', new InvariantError('Failed to create a new reply. Type mismatch')],
